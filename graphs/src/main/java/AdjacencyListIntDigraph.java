...
public class AdjacencyListIntDigraph implements IntGraph, IntDigraph {
    private final int V;
    private int E;
    ...
    /**
     * @pre v >= 0
     * @post Initialize a graph with v vertices and 0 edges.
     */
    ...
    /**
     * @pre 0 <= v < V && 0 <= w < V
     * @post Add the directed edge v-w to this graph.
     */
    @Override
